...
public class CollectionCreatePresenterImpl implements CollectionCreatePresenter, OnlineODataInterface {
    ...
    private InvoiceCreateView collCreateView;
    ...
    private String[][] mArrayDistributors, mArraySPValues = null,mArrayCPDMSDivisoins=null;
    ...
    public CollectionCreatePresenterImpl(Context mContext, InvoiceCreateView collCreateView, boolean isSessionRequired, Activity mActivity, InvoiceCreateBean invCreateBean) {
    ...
    public void responseSuccess(ODataRequestExecution oDataRequestExecution, List<ODataEntity> list, Bundle bundle) {
        ...
        if (totalRequest == currentRequest) {
            ...
            if (type == 4) {
                ...
                mArrayCPDMSDivisoins = Constants.getDMSDivisionByCPGUID(invCreateBean.getCPGUID());
                ...
                invCreateBean.setDmsDivision( mArrayCPDMSDivisoins[0][0] != null ? mArrayCPDMSDivisoins[0][0] : "");
                invCreateBean.setDmsDivisionDesc(mArrayCPDMSDivisoins[1][0] != null ? mArrayCPDMSDivisoins[1][0] : "");
                invCreateBean.setDmsDivQryBean(Constants.getDMSDIV(mArraySPValues[1][0]));
                ((Activity) mContext).runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        if (collCreateView != null) {
