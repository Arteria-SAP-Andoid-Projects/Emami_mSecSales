...
public class ReturnOrderDialogAdapter extends RecyclerView.Adapter<SampleDisbursementDialogVH> {
    private ArrayList<ReturnOrderBean> returnOrderBeanArrayList;
    private ArrayList<ReturnOrderBean> searchReturnOrderBeanArrayList;
    private Context mContext;

    public ReturnOrderDialogAdapter(Context context, ArrayList<ReturnOrderBean> returnOrderBeanArrayList) {
    ...
    public void onBindViewHolder(SampleDisbursementDialogVH holder, int position) {
        try {
            final ReturnOrderBean retailerStockBean = searchReturnOrderBeanArrayList.get(position);
    ...
    public void filter(final String text, final TextView tvEmptyRecord, final RecyclerView recyclerView,
        ...
        if (TextUtils.isEmpty(text) && TextUtils.isEmpty(brand) && TextUtils.isEmpty(productCatId) && TextUtils.isEmpty(orderMatGrpId)) {
            ...
            for (ReturnOrderBean item : returnOrderBeanArrayList) {
                ReturnOrderBean returnOrderBeanTwo = null;
                if (!brand.isEmpty()) {
