...
public class SchemeSalesAreaBean {
    private String CPGroup1ID = "";
    private String CPGroup1Desc = "";
    private String CPGroup2ID = "";
    private String CPGroup2Desc = "";
    private String CPGroup3ID = "";
    private String CPGroup3Desc = "";
    private String CPGroup4ID = "";
    private String CPGroup4Desc = "";
    private String finalGroupDesc = "";
    ...
    public String getFinalGroupDesc() {
        return finalGroupDesc;
    }

    public void setFinalGroupDesc(String finalGroupDesc) {
        this.finalGroupDesc = finalGroupDesc;
    }
}
