...
public class OtherBeatListAdapter extends ArrayAdapter<CustomerBean> {
    ...
    private String mStrRouteGuid="",mStrRouteName="";
    String mStrGeoLoc = "";
    ...
    public OtherBeatListAdapter(Context context, ArrayList<CustomerBean> items, String mStrRouteType,
                                TextView tvEmptyLay, String mStrRouteGuid, String mStrRouteName,HashMap<String,String> mapCPGrp3Desc,String mStrGeoLoc) {
    ...
    private void onListDetails(int id) {
        ...
        try {
            Intent intent=null;
            intent =new Intent(context, RetailersDetailsActivity.class);
            ...
            intent.putExtra(Constants.NoOfOutlet, String.valueOf(alRetailerList.size()));

            if(mStrRouteType.equalsIgnoreCase(context.getString(R.string.lbl_other_beats))){
                intent.putExtra(Constants.VisitCatID, Constants.OtherBeatVisitCatID);
                Constants.Visit_Cat_ID = Constants.OtherBeatVisitCatID;
            }else{
                intent.putExtra(Constants.VisitCatID, Constants.BeatVisitCatID);
                Constants.Visit_Cat_ID = Constants.BeatVisitCatID;
            }
