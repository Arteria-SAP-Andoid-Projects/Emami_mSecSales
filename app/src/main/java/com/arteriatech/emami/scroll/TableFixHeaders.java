package com.arteriatech.emami.scroll;
...
public class TableFixHeaders extends ViewGroup {
    ...
    private int[] widths;
    private int[] heights;
    private OnScrollViewInterface onScrollViewInterface = null;
     ...
     */
    public void setAdapter(TableAdapter adapter, OnScrollViewInterface onScrollViewInterface) {
        if (this.adapter != null) {
            this.adapter.unregisterDataSetObserver(tableAdapterDataSetObserver);
        }

        this.adapter = adapter;
        this.onScrollViewInterface = onScrollViewInterface;
    ...
    protected int computeVerticalScrollOffset() {
        ...
        int verticalScroll = heights[0] + Math.round(percentageOfViewScrolled * maxHorizontalScrollOffset);
//		if (onScrollViewInterface!=null){
//			onScrollViewInterface.onScrolled(verticalScroll);
//		}
